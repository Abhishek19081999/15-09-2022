...
public class TestApartmentInformation {
	public static void main(String args[])
	{
		...
		ap.setApartment("Gulmohar Apartment",0);
		ap.setApartment("Vinandini Villa",1);
		ap.setApartment("Krishna Enclave",2);
		ap.setApartment("Anandi Heights",3);
		ap.setApartment("Ranchi Heights",4);
		//
